...
import { Settings, Phone, Users, BarChart3, Smartphone, FileText, Database, Target } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              <img src="/logo.png" alt="金兰家居" className="h-8 w-auto sm:h-10" />
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <Dialog open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
                ...
                <DialogContent className={`max-w-2xl ${isDarkMode ? "bg-gray-800 border-gray-700" : ""}`}>
                  <DialogHeader>
                    ...
                    <DialogDescription>配置您的客服系统参数和偏好设置</DialogDescription>
                  </DialogHeader>
              ...
              >
                {isMobileMenuOpen ? <Phone className="w-4 h-4" /> : <Phone className="w-4 h-4" />}
              </Button>
            </div>
          </div>
        </div>
